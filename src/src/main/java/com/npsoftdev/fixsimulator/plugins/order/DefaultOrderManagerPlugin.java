...
import com.npsoftdev.fixsimulator.plugins.order.internal.GatewayOrderService;
import com.npsoftdev.fixsimulator.plugins.order.internal.GatewayTradeService;
import com.npsoftdev.fixsimulator.plugins.connection.internal.LiveSessionFacade;
import com.npsoftdev.fixsimulator.plugins.order.internal.OrderTradeCacheService;
import com.npsoftdev.fixsimulator.core.ui.BasePage;
import com.npsoftdev.fixsimulator.plugins.template.internal.DefaultFixMessageBuilder;
import com.npsoftdev.fixsimulator.plugins.template.internal.DefaultPlaceholderResolver;
import com.npsoftdev.fixsimulator.plugins.template.internal.DefaultTemplateService;
...
import com.npsoftdev.fixsimulator.plugins.template.internal.YamlDynamicValueRegistry;
import com.npsoftdev.fixsimulator.plugins.template.internal.YamlTemplateRepository;
import com.npsoftdev.fixsimulator.plugins.template.internal.YamlValueMappingService;
import com.npsoftdev.fixsimulator.core.logging.DefaultLogFileService;
...
import com.npsoftdev.fixsimulator.plugins.user.internal.YamlUserRepository;
...
import com.npsoftdev.fixsimulator.plugins.template.api.ValueMappingService;
...
public class DefaultOrderManagerPlugin implements SimulatorPlugin {
     ...
     * {@link com.npsoftdev.fixsimulator.plugins.template.api.FieldValue} variant:
     * <ul>
     *   <li>{@link com.npsoftdev.fixsimulator.plugins.template.api.FieldValue.Placeholder Placeholder}
     *       for ClOrdID and TransactTime;</li>
     *   <li>{@link com.npsoftdev.fixsimulator.plugins.template.api.FieldValue.UserInput UserInput}
     *       for Symbol, Side, OrderQty, Price, OrdType, TimeInForce;</li>
     *   <li>{@link com.npsoftdev.fixsimulator.plugins.template.api.FieldValue.Derived Derived}
     *       for SecurityID (looks up the ISIN for the user-entered Symbol);</li>
     *   <li>{@link com.npsoftdev.fixsimulator.plugins.template.api.FieldValue.Literal Literal}
