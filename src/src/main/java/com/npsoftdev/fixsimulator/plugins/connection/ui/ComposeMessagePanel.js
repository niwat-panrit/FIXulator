(function () {
    ...
    // ── Expose utilities globally so FixActivityPage.js modal handler can use them
    window.FIX = { TAG_NAMES: TAG_NAMES, VALUE_DECODERS: VALUE_DECODERS,
                   escHtml: escHtml, parseFix: parseFix };
    ...
    function parseComposeMsg() {
        ...
        // Read active session info for field annotation display
