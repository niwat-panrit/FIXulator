...
public class FixActivityPage extends BasePage {
    ...
    public FixActivityPage() {
        ...
        add(new ComposeMessagePanel("composePanel", tableBody, pagingFooter));
    ...
    public static String msgTypeName(String type) {
        if (type == null) return "";
        return switch (type) {
            case "0" -> "Heartbeat";
            case "1" -> "TestRequest";
    ...
    public static String buildSummary(String msgType, Map<String, String> tags) {
