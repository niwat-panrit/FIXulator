...
public class FixSimulatorSession extends WebSession {
     ...
     * Call {@link com.npsoftdev.fixsimulator.plugins.user.api.AuthService#registerSession} separately
     ...
     * Call {@link com.npsoftdev.fixsimulator.plugins.user.api.AuthService#unregisterSession} first
